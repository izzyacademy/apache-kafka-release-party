...
ENV PROJECT_KAFKA_VERSION="2.7.2"

# This is the Scala version
ENV PROJECT_SCALA_VERSION="2.13"

# This is the download URL for release artifacts
ENV PROJECT_DOWNLOAD_URL="https://home.apache.org/~mimaison/kafka-2.7.2-rc0/"
...
# docker build . -f Validation.Dockerfile -t izzyacademy/kafka-artifact-base:2.7.2-rc0
